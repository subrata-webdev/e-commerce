 ...
 <main class="ml-64 p-8">
    ...
    <form class="bg-white shadow-md rounded-lg p-6" @submit.prevent="submitForm">
      ...
      <div class="mb-4">
        ...
        <select id="currency" class="w-full p-2 border rounded-md" required v-model="form.currency">
      ...
      <!-- <div class="mb-4">
        <label for="currency" class="block text-gray-700 font-bold mb-2">Currency</label>
        <input type="text" id="currency" class="w-full p-2 border rounded-md" required v-model="form.currency">
      </div> -->
      <div class="mb-4">
        <label for="success-url" class="block text-gray-700 font-bold mb-2">Success URL</label>
        <input type="text" id="success-url" class="w-full p-2 border rounded-md" v-model="form.success_url" required>
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <input type="text" id="cancel-url" class="w-full p-2 border rounded-md" v-model="form.cancel_url" required>
      </div>
      <div class="mb-4">
